...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&pause=1000&center=true&vCenter=true&width=700&lines=Building+useful+software+and+AI+products;Exploring+AI+Agents+%26+LLM+Applications;Keep+building.+Keep+learning." alt="Typing SVG" />

<br />

长江大学 2024 级软件工程专业学生  
热爱 AI、软件工程、开源与开发者工具，喜欢把想法真正做成能运行、能落地、能被使用的产品。

<br />

<img src="https://komarev.com/ghpvc/?username=zhaoxinyi02&label=Profile%20Views&style=flat-square" alt="Profile Views" />
<img src="https://img.shields.io/github/followers/zhaoxinyi02?label=Followers&style=flat-square&logo=github" alt="GitHub Followers" />
...
```text
Name       赵鑫亿 / Zhao Xinyi
School     长江大学 · Yangtze University
Major      Software Engineering
Focus      AI · Developer Tools · Software Engineering
Status     Building, learning, shipping.
```

- 关注 **AI Agent、LLM 应用、开发者工具、桌面应用、Web 全栈、后端工程与自动化**
- 喜欢折腾新技术、数码与软硬件，也享受从 **0 → 1** 把想法做成完整产品
- 正在持续学习系统设计、数据库、操作系统以及 AI 工程化
- 相比只做 Demo，更喜欢真正可以长期使用、持续迭代的软件

## Tech Stack

<div align="center">

<img src="https://skillicons.dev/icons?i=go,python,ts,js,react,vue,nodejs,docker,linux,git,github,vscode&perline=12" alt="Tech Stack" />
...
`AI Agents` · `LLM Applications` · `Developer Tools` · `Automation`  
`Desktop Applications` · `Backend & System Design` · `Open Source`

</div>

## Let's Connect

如果你也对 AI、软件开发、开源工具这些方向感兴趣，欢迎看看我的仓库、提 Issue，或者一起做点有意思的东西。

<div align="center">

<a href="https://github.com/zhaoxinyi02">
  <img src="https://img.shields.io/badge/GitHub-zhaoxinyi02-181717?style=for-the-badge&logo=github" alt="GitHub" />
</a>
